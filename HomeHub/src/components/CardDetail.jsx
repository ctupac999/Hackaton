       ...
       <section className="d-flex justify-content-center">
           <div className="card mx-auto" style={{ width: "60rem", backgroundColor: "#F4F4FB", borderRadius: "8px", boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.1)", border: "none" }}>
               <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                   <div className="carousel-inner">
                       <div className="carousel-item active d-flex justify-content-center align-items-center">
                           <img src="/img/house-2-carousel.png" className="d-block w-100" alt="..." style={{ maxWidth: "60%", maxHeight: "60%",  marginTop: "20px" }} />
                       </div>
               ...
               <div className="card-body d-flex flex-column align-items-center">
                   ...
                   <a href="/Contact" className="btn btn-primary btn-lg" style={{ backgroundColor: "#003459", width: "200px", textAlign: "center" }}>Contactar</a>
